...
def get_task() :
    ...
    new_list = [{'start': ini_time_for_now, 'name' : item['name'], 'end': ini_time_for_now +  timedelta(days = random.randint(10,90)), "id" : item['name'], 'dependencies' : item['depends_on_tasks'], 'progress' : 100, "invalid" : False}  for item in task]
